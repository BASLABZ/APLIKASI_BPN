<?php 
    $row = mysql_fetch_array(mysql_query("SELECT * FROM penyerahan_berkas where idpenyerahan = '".$_GET['id']."'"));
       ...
       if (!empty($_FILES) && $_FILES['file']['size'] >0 && $_FILES['file']['error'] == 0) {
                     ...
                     if ($move) {
                        ...
                        if ($tanggal_sekarang <= 10) {
                          $queryinsert  = mysql_query("UPDATE penyerahan_berkas SET tgl_penyerahan = NOW(),
                                                         status_penyerahan='MENYERAHKAN BERKAS' , berkas='".$fileName."' WHERE idpenyerahan='".$_GET['id']."' ");
                        }else{
                          $queryinsert  = mysql_query("UPDATE penyerahan_berkas SET tgl_penyerahan = NOW(), 
                                                          status_penyerahan='ANDA TERLAMBAT MENYERAHKAN BERKAS' , berkas='".$fileName."' WHERE idpenyerahan='".$_GET['id']."' ");
                        }
        ...
        <div class="col-md-6">
          <div class="box box-danger">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                <label>Upload Berkas PPAT Ke BPN : <p><?php echo $row['berkas']; ?></p></label>
