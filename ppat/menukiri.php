  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="index.php?hal=teguran/list"><i class="fa fa-exclamation-triangle"></i> <span>Teguran</span></a></li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="index.php?hal=laporan/filter_perperiode_laporan"><i class="fa fa-circle-o"></i> LAPORAN PERIODE AKTA</a></li>
            <!--<li><a href="index.php?hal=laporan/filterlaporan"><i class="fa fa-circle-o"></i> LAPORAN AKTA PERBULAN </a></li>-->
