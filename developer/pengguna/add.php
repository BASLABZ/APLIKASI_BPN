  ...
  <?php 
        if (isset($_POST['simpan'])) {
          $query= mysql_query("INSERT INTO pengguna (NPWP,namalengkap,username,password,notelp,alamat,level,idkota)VALUES('".$_POST['NPWP']."','".$_POST['namalengkap']."','".$_POST['username']."',md5('$_POST[password]'),'".$_POST['notelp']."','".$_POST['alamat']."','".$_POST['level']."','".$_POST['idkota']."')");
          if ($query) {
        ...
        <div class="col-md-6">
          <div class="box box-danger">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                <label>Kota</label>
                <select class="form-control select" required="" name="idkota">
                  <option>Pilih Kota</option>
                  <?php 
                    $sqlkota = mysql_query("SELECT * FROM kota order by idkota DESC");
                    while ($rowkota = mysql_fetch_array($sqlkota)) {
                      echo "<option value='".$rowkota['idkota']."'>".$rowkota['nama_kota']."</option>";
                    }
                   ?>
                </select>
              </div>
