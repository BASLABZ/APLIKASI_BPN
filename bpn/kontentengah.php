            ...
            **Terdapat 
            ...
            <span class="fa fa-exclamation-triangle"></span>
              <?php 
                ...
                $jumlahdata =  mysql_query("SELECT count(verifikasi)  as jumlah from ppat p JOIN pengguna pe ON p.idpengguna = pe.idpengguna where p.verifikasi='BELUM DIVERIFIKASI' AND pe.idkota='".$_SESSION['idkota']."'  ");
