  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="index.php?hal=pengguna/list"><i class="fa fa-exclamation-triangle"></i> <span>Teguran</span></a></li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="index.php?hal=laporan/filterppatkeseluruhan" target="_BLANK"><i class="fa fa-circle-o"></i> LAPORAN KESELURUHAN</a></li>
          </ul>
        </li>
